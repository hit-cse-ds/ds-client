import { useAdminMoocsDataQuery, useVerifyMoocsMutation } from '@/redux/features/api/admin/adminApi';
...
const Verify:FC<Props> = ({setRoute,email,id}) => {
  ...
  const [verifyMoocs, { isSuccess, error, isLoading, data }] =
  useVerifyMoocsMutation();

const { refetch } = useAdminMoocsDataQuery({}, { refetchOnMountOrArgChange: true });
